...
public class RedisUtil {
    ...
    private static void initialPool() {
        //Redis服务器IP
        String HOST = "10.83.163.126";
        //Redis的端口号
        int PORT = NumberUtils.toInt("12684", 6379);
        //访问密码
        String AUTH = "goodluck";
        ...
        try {
            ...
            config.setMaxIdle(NumberUtils.toInt("50",50));
            //最小空闲数
    ...
    public synchronized static <T> T setList(String key, List<T> dataList){  
        ...
        T result = null;
        try { 
            List<T> list = (List<T>) getList(key, dataList.getClass());
     ...
     * @author jqlin
     */
    public static <T> List<T> getList(String key, Class<T> requiredType){  
        Jedis jedis = getJedis();
        if(jedis == null){
            return null;
        }
